...
class DeleteDataObatPresenter(val context: Context, var view: DeleteDataObatContract.View?) :
    DeleteDataObatContract.Presenter {
    ...
    override fun deleteDataObat(idObat: String) {
        Network.request(context, call = ApiProvider.create()
            .deleteObat(apiKey!!, idObat),
            success = {
