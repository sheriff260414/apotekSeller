...
class UpdateStatusPesananObatFragment : DialogFragment(), View.OnClickListener,
    UpdateStatusPesananObatContract.View {

    override lateinit var presenter: UpdateStatusPesananObatContract.Presenter
    private var mView: View? = null
    private var loading: AlertDialog? = null
    lateinit var mCallback: OnCloseFragmentUpdateStatusPesananObat
    private lateinit var pesananObatUpdateStatusBody: PesananObatUpdateStatusBody
    ...
    override fun onCreateView(
        ...
        mView = inflater.inflate(R.layout.fragment_update_status_pesanan_obat, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        UpdateStatusPesananObatPresenter(requireContext(), this)
        ...
        if (bundle != null) {
            ...
            idPesananMobile = item.idPesananMobile.toInt()
    ...
    private fun initSpStatus() {
        ...
        sp_status.adapter = adapterStatus
        ...
        sp_status.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                namaStatus = sp_status.selectedItem.toString()
            }
        }
        sp_status.setSelection(posStatus!!)
    }
        ...
        when (p0?.id) {
            btnSaveUpdatestatus.id -> {
                if (handleInput()) {
                    ...
                    pesananObatUpdateStatusBody = PesananObatUpdateStatusBody(
                        biayaTambahan!!,
                        idPesananMobile!!,
                        namaStatus!!,
                        biayaTotal!!
                    ...
                    presenter.updateStatusPesananObat(pesananObatUpdateStatusBody)
    ...
    override fun onUpdateSuccess(message: String) {
        this.dismiss()
        mCallback.onCloseFragmentUpdateStatusPesananObat(true)
    }
    ...
    override fun onAttach(context: Context) {
        ...
        try {
            mCallback = context as OnCloseFragmentUpdateStatusPesananObat
        } catch (e: ClassCastException) {
            Log.d(
                "Create Dialog",
                "Activity doesn't implement the OnCloseFragmentUpdateStatusPesananObat interface"
            )
        }
    }

    interface OnCloseFragmentUpdateStatusPesananObat {
        fun onCloseFragmentUpdateStatusPesananObat(b: Boolean)
    }
